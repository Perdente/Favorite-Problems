...
Here the array pattern is:
7
1 4 5 8 9 12 13 2 3 6 7 10 11 14
Implementation:
1.Two arrays 1st one is for [4 5 8 9 12 13] and 2nd one is for [2 3 6 7 10 11] two are merged into one arr[2*n].
2.Here the difference with i is for 1st array [2 2 4 4 6 6] for 2nd array[6 6 4 4 2 2]
3.Here for 1st array every even elements temp incremented to 1 and cnt=temp*2.
4.Again for 2nd array every odd elements temp incremented to 1 and cnt=temp*2.
*/
#include<bits/stdc++.h>
using namespace std;
