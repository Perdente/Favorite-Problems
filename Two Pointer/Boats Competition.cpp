...
/* Here as the max weight is 100 so I create total no of teams from weight 1 to 100 */
...
long long a,b,c,d,e,f,g,h,l,i,j,k,m,n,o,p,q,r,s,t,u,v,w,x,y,z,cnt=0,cnt1=0,cnt2=0,cnt3=0,cnt4=0,sum=0,sum1=0,sum2=0,ans=0,ans1=0,ans2=0,sum3=0,ma=0,ma1=0,ma2=0,mi=inf,mi1=inf,temp=0,temp1=0,temp2=0;
