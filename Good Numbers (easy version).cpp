...
1.Here the nearest good number is either the n(the number itself) or greater than n.
2.If n%3==1 then we can use 3^0 which is 1 to make the number good. 
3.But if n%3==2 then we can not use 3^1 as it is 3.So we increase our ans+1.
4.In which ans is divisible by 3 or modulo 1 we can take the ans.
*/
